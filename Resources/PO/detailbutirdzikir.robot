...
Click others button
    ...
    Click Element    xpath://*[@id="root"]/div[2]/div[2]/form/div/div[3]/div[5]/div[1]/table/tbody/tr/td[5]/div/button
    Click Element    xpath://*[@id="simple-menu"]/div[3]/ul/li

Verify detail success
    [Arguments]    ${title}
    Get Element Attribute    name:dzikirDetails[0].doaName    ${title}
